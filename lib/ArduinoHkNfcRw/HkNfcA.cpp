...
bool HkNfcA::write(uint8_t* buf, const uint8_t* dat, uint8_t blockNo)
{
	NfcPcd::commandBuf(0) = WRITE;
	NfcPcd::commandBuf(1) = blockNo;
	NfcPcd::commandBuf(2) = dat[0];
	NfcPcd::commandBuf(3) = dat[1];
	NfcPcd::commandBuf(4) = dat[2];
	NfcPcd::commandBuf(5) = dat[3];
